...
.PHONY: help install setup-hooks dev back front test test-back test-front lint format up down logs clean
...
dev: ## Roda backend + frontend juntos, em paralelo
	@$(MAKE) -j2 back front
...
up: ## Sobe todo o ambiente (API + banco + frontend)
